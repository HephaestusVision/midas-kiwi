...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  if ([url isFileURL]) {
    NSLog(@"didFinishLaunching Opening file: %@", [url path]);
    NSDictionary* args = [NSDictionary dictionaryWithObjectsAndKeys:[url path], @"dataset", nil];
...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
  ...
  if ([url isFileURL]) {
    NSLog(@"openURL Opening file: %@", [url path]);
    NSDictionary* args = [NSDictionary dictionaryWithObjectsAndKeys:[url path], @"dataset", nil];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"switchToRenderView" object:nil userInfo:args];
  }
